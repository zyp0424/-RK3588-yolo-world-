...
{
    return init_post_process_with_label_path(LABEL_NALE_TXT_PATH);
}

int init_post_process_with_label_path(const char* label_path)
{
    int ret = 0;
    const char* path = label_path != nullptr ? label_path : LABEL_NALE_TXT_PATH;
